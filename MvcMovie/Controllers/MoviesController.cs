...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        {
            var movies = from s in _context.Movie select s;
            int pageSize = 2;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> CreateReview([Bind("userName,Comment,MovieId")] Review review)
        {
